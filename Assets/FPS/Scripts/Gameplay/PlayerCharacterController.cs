...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        void HandleLean()
        {
            ...
            // Smoothly rotate the player body for leaning effect
            float leanRotation = Mathf.LerpAngle(transform.localEulerAngles.z, targetLean, Time.deltaTime * leanSpeed);
            transform.localEulerAngles = new Vector3(transform.localEulerAngles.x, transform.localEulerAngles.y, leanRotation);
        }
